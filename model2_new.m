...
[s01, c01, m01] = polynomial(x,0);
[s02, c02, m02] = polynomial(x,0);
[s03, c03, m03] = polynomial(x,0);
...
[s21, c21, m21] = polynomial(x,0);
[s22, c22, m22] = polynomial(x,0);
[s23, c23, m23] = polynomial(x,0);
...
[s31, c31, m31] = polynomial([x;d],4);
[s32, c32, m32] = polynomial([x;d],4);
[s33, c33, m33] = polynomial([x;d],4);
...
%             + gamma*Barrier * den1*den2 ) ...
%             - (s31*safe_set1 + s32*safe_set2 + s33*safe_set3);
